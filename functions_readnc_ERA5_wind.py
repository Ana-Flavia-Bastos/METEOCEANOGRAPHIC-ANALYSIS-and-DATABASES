...
def dfseries(nc,latitude_idx,longitude_idx,dtime_l):
    ...
    u10_l=[];v10_l=[];msl_l=[];t2m_l=[];sst_l=[]
    
    for t in range(len(dtime_l)):
        u10_l.append(nc.variables['u10'][t,latitude_idx,longitude_idx])
        v10_l.append(nc.variables['v10'][t,latitude_idx,longitude_idx])
        msl_l.append(nc.variables['msl'][t,latitude_idx,longitude_idx]/100.0)
        t2m_l.append(nc.variables['t2m'][t,latitude_idx,longitude_idx]-273.15)
        sst_l.append(nc.variables['sst'][t,latitude_idx,longitude_idx]-273.15)

    df_temp=pd.DataFrame(zip(dtime_l,u10_l,v10_l,msl_l,t2m_l,sst_l))
