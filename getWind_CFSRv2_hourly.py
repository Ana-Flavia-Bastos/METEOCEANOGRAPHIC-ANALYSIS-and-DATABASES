...
#year_inicial=input('Provide the First year of data (Years available: 2012 - 2023): ')
#year_final=input('Provide the Last year of data (Years available: 2012 - 2023): ')
date_start = '2012-01-01 01:00:00'
date_final = '2023-01-01 00:00:00'

# - - -
# specify the directory where the extracted nc files will be saved:
ThreddsUrl = 'https://thredds.rda.ucar.edu/thredds/ncss/grid/files/g/ds094.1/'         # include the ending '/'
...
def correct_longitude_degree(degree):
    if degree<0:
        degree_corrected = degree+359.795 # 0 to 360 degE
    elif degree==0:
...
def get_extraction(dt_i,dt_f,out_fn):
    ...
    url =(ThreddsUrl+str(year)+'/wnd10m.cdas1.'+str(year)+str(month)+'.grb2'+
...
print('\n** Working on dowload of CFSR version 2 **')
